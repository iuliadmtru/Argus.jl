...
\emph{embedded domain-specific language} for syntax
...
pattern. Bound pattern variables are returned in corresponding binding sets.
...
\begin{figure}[h!]
\hspace{0.2cm}\includegraphics[height=0.3\textwidth]{parser.png}
\end{figure}
...
My gratitude goes to my coordinating professor as well, Mihnea Muraru,
whose  courses have inspired me to pursue the challenging yet
rewarding field of compilers.
