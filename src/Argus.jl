...
export SyntaxPatternNode, Pattern, @pattern, CommentPattern, @comment, Template, @template,
...
export syntax_match, partial_syntax_match, syntax_match_all, comment_match_all,
    is_successful, MatchFail, MatchError, MatchResults
export expand
